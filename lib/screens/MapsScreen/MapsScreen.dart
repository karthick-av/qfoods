...
import 'package:qfoods/screens/CheckOutScreen/CheckOutScreen.dart';
...
//  }
              ...
              CheckOutScreen(checkOut: _checkout)),
            );
              ...
              final data = addressController;
                ...
                print(_checkout.AreaAndFloor);
                print(_checkout.address1);
                print(_checkout.address2);
                 print(_checkout.alternate_phone_number);
                  print(_checkout.instructions);
                   print(_checkout.landMark);
                    print(_checkout.latitude);
                     print(_checkout.longitude);
                   Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => 
              CheckOutScreen(checkOut: _checkout)),
